...
*  This is set up in a so called "reactive environment" **TODO: Read up a bit more on the sematics here** meaning that the code in here will be ready to run as soon as some of the parameters from the interface that is used is changed.
